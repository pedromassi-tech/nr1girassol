    ...
    return (
      ...
      >
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center gap-3">
          <a href="https://chat.whatsapp.com/Dj8pvjQAaNJE06oqDzfeya?mode=gi_t" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">="https://chat.whatsapp.com/Dj8pvjQAaNJE06oqDzfeya?mode=gi_t" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto"> target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
